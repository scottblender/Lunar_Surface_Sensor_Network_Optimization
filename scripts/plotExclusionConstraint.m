...
fig = figure("Color",backgroundColor,"Units","inches", ...
...
text(ax,target(1)+0.11,target(2),"RSO", ...
    "Color",textColor,"FontName",fontName,"FontSize",objectFontSize, ...
    "HorizontalAlignment","left","VerticalAlignment","middle");
text(ax,body(1),body(2)-0.88,"Celestial body $b$", ...
    "Interpreter","latex","Color",textColor,"FontName",fontName, ...
    "FontSize",objectFontSize,"HorizontalAlignment","center");
...
text(ax,occLabel(1),occLabel(2)-0.22,"$\theta_{\mathrm{occ},b}$", ...
    "Interpreter","latex","Color",occultationColor,"FontName",fontName, ...
    "FontSize",angleFontSize,"FontWeight","bold","HorizontalAlignment","center");
text(ax,minLabel(1),minLabel(2)+0.17,"$\theta_{\min}$", ...
    "Interpreter","latex","Color",minimumAngleColor,"FontName",fontName, ...
    "FontSize",angleFontSize,"FontWeight","bold","HorizontalAlignment","center");
text(ax,targetLabel(1),targetLabel(2)+0.16,"$\theta_b$", ...
