...
% Move the occultation label right of the small arc so it remains visually
% separated from the surface-sensor label and occultation boundary.
text(ax,occLabel(1)+0.14,occLabel(2)-0.27,"$\theta_{\mathrm{occ},b}$", ...
