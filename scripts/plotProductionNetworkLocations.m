...
for objectiveIndex = 1:numel(config.objectiveModes)
    ...
    annotation(fig,"textbox",[0.20 0.002 0.60 0.04], ...
        "String",sprintf("Marker area proportional to selection frequency across %d runs", ...
        config.numberOfRuns),"HorizontalAlignment","center", ...
