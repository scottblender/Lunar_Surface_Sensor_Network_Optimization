...
fig = figure("Name","Operational RSO tracking performance", ...
    ...
    "Position",[0.5 0.5 9.5 7.0], ...
    "Renderer","opengl");
fig.InvertHardcopy = "off";

% Leave extra room on the left for full spacecraft names at the large
% manuscript font size. The right column is kept clear of the color bars.
axisPositions = [ ...
    0.17 0.57 0.28 0.30; ...
    0.52 0.57 0.28 0.30; ...
    0.17 0.13 0.28 0.30; ...
...
annotation(fig,"textbox",[0.17 0.935 0.63 0.045], ...
...
rmsColorbar.Position = [0.84 0.57 0.022 0.30];
...
obsColorbar.Position = [0.84 0.13 0.022 0.30];
