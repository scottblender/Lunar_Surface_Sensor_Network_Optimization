%% plotClpsLsp
% Generate the white-background CLPS lunar south-polar manuscript map.
%
% Output:
%   CLPS_LSP_Detail.eps
%
% The figure retains the detailed mission callouts, latitude/longitude
% references, regional overlays, and the 75 deg S optimization boundary.
...
%% White manuscript theme

theme = struct( ...
    "name","CLPS south-polar map", ...
...
exportgraphics(clpsFigure,outputFile, ...
    "ContentType","image","Resolution",600, ...
    "BackgroundColor",theme.backgroundColor,"Colorspace","rgb");
...
% Keep the on-screen window compact enough for a laptop while retaining the
% same normalized composition and 12-pt minimum manuscript typography.
fig = figure("Name",theme.name, ...
    "Color",theme.backgroundColor,"Units","inches", ...
    "Position",[0.5 0.5 10.5 6.3],"Renderer","opengl");
...
% it clear of the right-side mission callouts.
