...
if isfield(database.tracking,"measurementJacobianChunks") && ...
    ...
    objectiveDatabase.candidates.jacobianChunkIndex = ...
        database.candidates.jacobianChunkIndex;
    objectiveDatabase.candidates.jacobianChunkLocalIndex = ...
        database.candidates.jacobianChunkLocalIndex;
else
