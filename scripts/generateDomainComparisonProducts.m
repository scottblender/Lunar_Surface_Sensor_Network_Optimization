...
setappdata(locationFig,"ManuscriptTypographyScale",1.22);
...
h1 = scatter(ax,mod(rad2deg(fullInfo.bestSensorLongitudesRad),360), ...
    rad2deg(fullInfo.bestSensorLatitudesRad),160,"o", ...
...
h2 = scatter(ax,mod(rad2deg(fullCoverage.bestSensorLongitudesRad),360), ...
    rad2deg(fullCoverage.bestSensorLatitudesRad),160,"s", ...
    "MarkerFaceColor",style.redColor, ...
    "MarkerEdgeColor",[1 1 1],"LineWidth",1.5);
h3 = scatter(ax,mod(rad2deg(restrictedInfo.bestSensorLongitudesRad),360), ...
    rad2deg(restrictedInfo.bestSensorLatitudesRad),180,"o", ...
    "MarkerFaceColor",[1 1 1],"MarkerEdgeColor",style.blueColor, ...
    "LineWidth",2.5);
h4 = scatter(ax,mod(rad2deg(restrictedCoverage.bestSensorLongitudesRad),360), ...
    rad2deg(restrictedCoverage.bestSensorLatitudesRad),180,"s", ...
